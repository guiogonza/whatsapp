 ...
 * Excluye la sesión GPSwox dedicada (solo para registro de vehículos, no envíos masivos)
...
function getActiveSessions() {
    ...
    return Object.keys(_sessions)
        ...
        .filter(s => s.state === config.SESSION_STATES.READY && s.socket && s.name !== gpswoxSessionName);
}
