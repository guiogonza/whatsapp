...
module.exports = {
    ...
    NOTIFICATION_INTERVAL_MINUTES: parseInt(process.env.NOTIFICATION_INTERVAL_MINUTES, 10) || 60,
    ...
    MAX_MESSAGES_PER_SESSION_PER_HOUR: parseInt(process.env.MAX_MESSAGES_PER_SESSION_PER_HOUR) || 120,
    
    // Anti-ban: Delay mínimo y máximo entre mensajes (en segundos)
    // Con 120 msgs/hora = 2 por minuto = delay 30s entre mensajes consolidados
    MIN_DELAY_SECONDS: parseInt(process.env.MIN_DELAY_SECONDS) || 30,
    MAX_DELAY_SECONDS: parseInt(process.env.MAX_DELAY_SECONDS) || 30,
