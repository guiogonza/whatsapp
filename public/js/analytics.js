...
function hideAnalyticsSelectedMessages() {
    ...
    if (body) {
        body.innerHTML = '<tr><td colspan="4" class="py-4 text-center text-gray-500">Selecciona un n�mero</td></tr>';
    }
...
async function loadAnalyticsMessagesForPhone(phone) {
    ...
    try {
        ...
        if (data.messages.length === 0) {
            body.innerHTML = '<tr><td colspan="4" class="py-4 text-center text-gray-500">No hay mensajes para este n�mero</td></tr>';
            return;
        }
        ...
        console.error('Error cargando mensajes del n�mero:', error);
